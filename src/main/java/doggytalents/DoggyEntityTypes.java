...
public class DoggyEntityTypes {
    ...
    public static final RegistryObject<EntityType<Piano>> UPRIGHT_PIANO_WHITE = register("upright_piano_white", (type, level) -> new Piano(type, level, PianoType.UPRIGHT, PianoColor.WHITE), MobCategory.MISC,
        b -> b
            .sized(3f, 3f)
            .setUpdateInterval(4)
            .setTrackingRange(10)
