...
public class HeelByGroupScreen extends Screen {
   ...
   private int hightlightTextColor = HLC_HEEL_NO_SIT;
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        fill(stack, half_width - 100, half_height - 100, half_width + 100, half_height + 100, Integer.MIN_VALUE);
        fill(stack, half_width - 100, half_height + 105, half_width + 100, half_height + 117, Integer.MIN_VALUE);
