...
public class CombatReturnSwitch extends AbstractWidget {
    ...
    protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float pTicks) {
        ...
        back_c1.withStyle(Style.EMPTY.withBold(hoveredLeft));
        ...
        next_c1.withStyle(Style.EMPTY.withBold(hoveredRight));
        ...
        if (this.timeHoveredWithoutClick >= 25) {
            setOverlayToolTip(mouseX, mouseY);
        }
    }
    ...
    public void setOverlayToolTip(int mouseX, int mouseY) {
