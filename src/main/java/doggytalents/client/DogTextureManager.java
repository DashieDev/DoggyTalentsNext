...
public class DogTextureManager extends SimplePreparableReloadListener<DogTextureManager.DogSkinLoadResult> {
    ...
    private synchronized RegisterState registerDogSkin(DogTextureManager.DogSkinLoadResult prep, ResourceManager resMan, ResourceLocation text_rl, DogSkin dogSkin) {        
