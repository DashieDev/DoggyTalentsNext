...
//        this.addLayer(new DogAccessoryLayer(this, ctx));
    ...
    //if users opt for it.
     ...
     public void MobRenderer_render(Dog p_115455_, float p_115456_, float p_115457_, PoseStack p_115458_, MultiBufferSource p_115459_, int p_115460_) {
        ...
        var entity = p_115455_.getLeashHolder();
        if (entity != null) {
           this.MobRenderer_renderLeash(p_115455_, p_115457_, p_115458_, p_115459_, entity);
        }
     }
    ...
    private static void MobRenderer_addVertexPair(VertexConsumer p_174308_, Matrix4f p_174309_, float p_174310_, float p_174311_, float p_174312_, int p_174313_, int p_174314_, int p_174315_, int p_174316_, float p_174317_, float p_174318_, float p_174319_, float p_174320_, int p_174321_, boolean p_174322_) {
