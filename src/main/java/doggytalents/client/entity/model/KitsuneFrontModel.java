...
public class KitsuneFrontModel extends SyncedAccessoryModel {

    public KitsuneFrontModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createKitsuneFrontLayer() {
