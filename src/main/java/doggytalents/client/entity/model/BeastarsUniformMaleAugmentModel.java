...
public class BeastarsUniformMaleAugmentModel extends SyncedAccessoryModel {
    ...
    public static LayerDefinition createLayer() {
		...
		.texOffs(54, 13).mirror().addBox(-0.5F, -5.5F, -0.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(0, 2.5f, -2.5f));
		...
		.texOffs(54, 11).addBox(-3.0F, -6.0F, 0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)), PartPose.offset(0, 2.5f, -2.5f));
