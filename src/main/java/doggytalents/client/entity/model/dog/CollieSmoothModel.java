...
public class CollieSmoothModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.0F, 15.0F, -3.5F, 1.5708F, 0.0F, 0.0F));

		PartDefinition bone3 = upper_body.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, -0.4219F, 4.1251F, -1.5708F, 0.0F, 0.0F));

		PartDefinition bone = bone3.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(21, 0).addBox(-4.0F, -2.3561F, -3.0176F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 4.3898F, 0.1785F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition bone4 = body.addOrReplaceChild("bone4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition body_rotation_r1 = bone4.addOrReplaceChild("body_rotation_r1", CubeListBuilder.create().texOffs(20, 14).addBox(-3.0F, -12.75F, -2.5F, 6.0F, 9.0F, 6.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 2.0F, 10.0F, 1.5272F, 0.0F, 0.0F));
		...
		.texOffs(9, 23).addBox(0.0F, 8.5F, 1.8F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offset(-1.0F, -0.35F, 0.0F));
