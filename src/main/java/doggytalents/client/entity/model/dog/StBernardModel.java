...
public class StBernardModel extends DogModel<Dog> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(36, 13).mirror().addBox(-0.75F, 0.48F, -4.75F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(36, 13).addBox(1.75F, 0.48F, -4.75F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		.texOffs(16, 12).mirror().addBox(3.4F, -12.7F, -9.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offset(1.0F, 10.5F, 7.0F));
		...
		.texOffs(16, 12).addBox(-4.4F, -12.7F, -9.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(-0.05F)), PartPose.offset(1.0F, 10.5F, 7.0F));
