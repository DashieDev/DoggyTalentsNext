...
public class FrenchBulldogModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(0.0F, 14.75F, 5.5F));

		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(9, 18).addBox(-1.0F, -1.1548F, -0.7716F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F))
		.texOffs(9, 18).addBox(-0.25F, -0.6548F, -0.7716F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.25F))
		.texOffs(9, 18).addBox(-0.95F, 0.6952F, -0.7716F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.55F))
		.texOffs(9, 18).addBox(-0.15F, 0.2952F, -0.7716F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.65F))
		.texOffs(9, 18).addBox(-1.65F, 0.1952F, -0.7716F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.65F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition right_hind_leg = partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, 1.0F, -2.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.05F)), PartPose.offset(-1.5F, 18.0F, 4.75F));

		PartDefinition left_hind_leg = partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, 1.0F, -2.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.05F)), PartPose.offset(1.5F, 18.0F, 4.75F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 16.65F, 1.5F, 1.3526F, 0.0F, 0.0F));

		PartDefinition body_rotation_r1 = body.addOrReplaceChild("body_rotation_r1", CubeListBuilder.create().texOffs(18, 14).addBox(-3.0F, -3.7452F, -2.8911F, 6.0F, 7.0F, 6.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.9651F, -0.3373F, 0.2182F, 0.0F, 0.0F));

		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(21, 0).addBox(-4.0F, -3.0F, -3.75F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.45F)), PartPose.offsetAndRotation(0.0F, 17.0F, -3.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 16.0F, -6.0F));
		...
		.texOffs(1, 1).addBox(-3.0F, -3.85F, -1.75F, 6.0F, 2.0F, 3.0F, new CubeDeformation(-0.65F))
		.texOffs(1, 1).addBox(-3.0F, -3.4F, -2.15F, 6.0F, 2.0F, 3.0F, new CubeDeformation(-0.55F))
		.texOffs(1, 0).addBox(-3.0F, -3.0F, -2.35F, 6.0F, 2.0F, 3.0F, new CubeDeformation(-0.45F))
		.texOffs(12, 11).addBox(1.0F, 0.08F, -3.25F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.2F))
		.texOffs(12, 11).addBox(-2.0F, 0.08F, -3.25F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.2F))
		.texOffs(0, 11).addBox(-1.5F, -0.47F, -3.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition right_ear = real_head.addOrReplaceChild("right_ear", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.7214F, -2.1064F, -0.429F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition left_ear = real_head.addOrReplaceChild("left_ear", CubeListBuilder.create(), PartPose.offsetAndRotation(1.7214F, -2.1064F, -0.429F, 0.0F, 0.0F, 0.3927F));
