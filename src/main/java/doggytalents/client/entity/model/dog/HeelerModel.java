...
public class HeelerModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(58, 49).addBox(-1.0F, 0.3078F, -1.1746F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.2F, 4.65F));

		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create(), PartPose.offset(0.0F, 0.7578F, 0.2254F));

		PartDefinition right_hind_leg = partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(59, 19).mirror().addBox(-0.9F, 3.4346F, -0.1525F, 2.0F, 4.6F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.0F, 16.0F, 5.8133F));
		...
		PartDefinition left_hind_leg = partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(59, 19).addBox(-1.1F, 3.4346F, -0.1525F, 2.0F, 4.6F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 16.0F, 5.8133F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 14.7065F, -0.1377F, 1.5708F, 0.0F, 0.0F));

		PartDefinition bone = body.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(2, 110).addBox(-3.0F, -3.0F, -5.5609F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.1781F, 0.7486F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 15.0F, -6.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition bone2 = upper_body.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 56).addBox(-2.95F, -3.0F, -2.0F, 6.0F, 7.0F, 5.0F, new CubeDeformation(-0.09F)), PartPose.offsetAndRotation(0.0F, 1.6346F, 0.8609F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.9654F, -1.6391F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(16, 17).addBox(-1.0F, -0.3F, -5.1391F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r11 = real_head.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 14).addBox(-2.5F, -0.2055F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, -1.5945F, 2.652F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r12 = real_head.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(11, 20).addBox(-2.5F, -0.551F, -3.2099F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.451F, 3.2099F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r13 = real_head.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(13, 27).addBox(-3.2F, -3.2422F, -4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.2768F, 0.5609F, 0.0F, -0.48F, 0.0F));

		PartDefinition cube_r14 = real_head.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(17, 11).addBox(-2.0F, -0.5F, -0.4276F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2467F, -0.9687F, -1.6724F, -0.0436F, 0.1745F, 0.0F));

		PartDefinition cube_r15 = real_head.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(13, 27).mirror().addBox(1.2F, -3.2422F, -4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.2768F, 0.5609F, 0.0F, 0.48F, 0.0F));

		PartDefinition cube_r16 = real_head.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(17, 11).mirror().addBox(0.0F, -0.5F, -0.3276F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.2467F, -0.9687F, -1.6724F, -0.0436F, -0.0873F, 0.0F));

		PartDefinition cube_r17 = real_head.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(0, 28).addBox(-1.0F, -0.8422F, -0.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.7768F, -4.4391F, 0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r18 = real_head.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(27, 28).addBox(-1.0F, -0.8317F, -1.159F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5337F, -1.7801F, 0.8727F, 0.0F, 0.0F));

		PartDefinition head_r1 = real_head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5346F, -2.4391F, -0.1745F, 0.0F, 0.0F));
		...
		.texOffs(39, 4).addBox(-0.3879F, -3.1811F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(2.4879F, -2.2687F, 0.5609F));
		...
		.texOffs(39, 4).mirror().addBox(-0.6121F, -3.1811F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.4879F, -2.2687F, 0.5609F));
