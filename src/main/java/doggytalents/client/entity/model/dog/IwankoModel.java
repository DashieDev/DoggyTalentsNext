...
public class IwankoModel extends DogModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 35).addBox(1.75F, -6.0F, 6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offset(0, 2.5f, -2.5f));

		CubeListBuilder var4 = CubeListBuilder.create().texOffs(0, 18).addBox(-1F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F);
        ...
        PartDefinition real_tail_1 = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(56, 0).addBox(-1F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, CubeDeformation.NONE)
