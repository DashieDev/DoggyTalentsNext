...
public class SparkyModel extends GlowingEyeDogModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_rotation_r1 = bodye.addOrReplaceChild("body_rotation_r1", CubeListBuilder.create().texOffs(40, 50).addBox(-3.0F, -4.7452F, -3.1411F, 6.0F, 8.0F, 6.0F, new CubeDeformation(-0.24F))
		.texOffs(18, 14).addBox(-3.0F, -4.7452F, -3.1411F, 6.0F, 8.0F, 6.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.7319F, 2.6496F, 1.789F, 0.0F, 0.0F));

		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(21, 0).addBox(-3.0F, -3.25F, -3.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.5F))
		.texOffs(0, 39).addBox(-3.0F, -3.25F, -3.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.49F)), PartPose.offsetAndRotation(-1.0F, 16.5F, -3.0F, 1.5708F, 0.0F, 0.0F));
		...
		.texOffs(32, 31).addBox(0.25F, 0.15F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.7F))
		.texOffs(35, 31).addBox(3.0F, 0.15F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F))
		.texOffs(32, 31).mirror().addBox(-4.15F, 0.15F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.7F)).mirror(false)
		.texOffs(35, 31).mirror().addBox(-3.9F, 0.15F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = real_head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(56, 20).addBox(-0.25F, -0.5F, -1.0F, 1.5F, 1.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(2.3831F, -2.5516F, -2.0F, 0.0F, 0.0F, 0.3491F));

		PartDefinition cube_r2 = real_head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(56, 20).mirror().addBox(-1.25F, -0.5F, -1.0F, 1.5F, 1.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(-2.3831F, -2.5516F, -2.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r3 = real_head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(56, 20).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(1.95F, -2.6F, -2.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition cube_r4 = real_head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(56, 20).mirror().addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(-1.95F, -2.6F, -2.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition head_r1 = real_head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(40, 14).addBox(-3.2F, 0.8F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(1.7F, 0.18F, -3.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition head_r2 = real_head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(54, 7).mirror().addBox(2.2F, -1.25F, -3.7F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-1.7F, -0.32F, -2.5F, 0.5444F, 0.2635F, 0.1564F));

		PartDefinition head_r3 = real_head.addOrReplaceChild("head_r3", CubeListBuilder.create().texOffs(54, 7).addBox(-4.2F, -1.25F, -3.7F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.7F, -0.32F, -2.5F, 0.5444F, -0.2635F, -0.1564F));
		...
		.texOffs(50, 26).addBox(-2.9F, -1.25F, -4.9F, 2.4F, 2.0F, 3.0F, new CubeDeformation(0.101F)), PartPose.offsetAndRotation(1.7F, -0.32F, -2.5F, 0.5236F, 0.0F, 0.0F));

		PartDefinition head_r5 = real_head.addOrReplaceChild("head_r5", CubeListBuilder.create().texOffs(0, 29).addBox(-4.5F, -1.8F, -3.9F, 5.0F, 2.0F, 7.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(1.7F, -0.32F, -2.5F, 0.4363F, 0.0F, 0.0F));

		PartDefinition head_r6 = real_head.addOrReplaceChild("head_r6", CubeListBuilder.create().texOffs(1, 11).addBox(-3.7F, -1.25F, -1.95F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(1.7F, -0.07F, -2.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition head_r7 = real_head.addOrReplaceChild("head_r7", CubeListBuilder.create().texOffs(1, 0).addBox(-5.3F, -3.1F, -0.75F, 5.0F, 5.0F, 4.0F, new CubeDeformation(-0.69F)), PartPose.offsetAndRotation(2.8F, -0.5F, 0.5F, -1.2654F, 0.0F, 0.0F));
