...
public class DobermanModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mane_rotation_r1 = upper_body.addOrReplaceChild("mane_rotation_r1", CubeListBuilder.create().texOffs(21, 0).addBox(-4.0F, -2.5905F, -3.7852F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.95F)), PartPose.offsetAndRotation(1.0F, -2.1059F, 1.6384F, -0.7418F, 0.0F, 0.0F));
