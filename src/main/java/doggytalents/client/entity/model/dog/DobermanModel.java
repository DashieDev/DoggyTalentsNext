...
public class DobermanModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_rotation_r1 = body.addOrReplaceChild("body_rotation_r1", CubeListBuilder.create().texOffs(20, 14).addBox(-3.0F, -13.0F, -3.25F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 11.0F, 1.4399F, 0.0F, 0.0F));
		...
		PartDefinition mane_rotation_r1 = upper_body.addOrReplaceChild("mane_rotation_r1", CubeListBuilder.create().texOffs(21, 0).addBox(-4.0F, -3.0F, -3.75F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.95F)), PartPose.offsetAndRotation(1.0F, -2.5496F, 1.6581F, 0.5672F, 0.0F, 0.0F));
