...
public class ShikokuModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.0F, 14.75F, 5.5F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(18, 14).addBox(-3.0F, -2.7F, -2.25F, 6.0F, 9.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 15.5F, 2.0F, 1.6144F, 0.0F, 0.0F));

		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(21, 0).addBox(-3.0F, -2.75F, -2.65F, 8.0F, 6.0F, 7.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-1.0F, 15.5F, -3.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 12.5F, -4.75F));

		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.5F, -2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, -1.0F));

		PartDefinition head_r1 = real_head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(43, 19).addBox(-1.5F, -1.0F, -3.45F, 3.0F, 1.0F, 3.0F, new CubeDeformation(-0.35F)), PartPose.offsetAndRotation(0.0F, 0.48F, -3.0F, 1.1781F, 0.0F, 0.0F));

		PartDefinition head_r2 = real_head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(37, 14).addBox(-1.5F, -0.4F, -1.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(-0.24F)), PartPose.offsetAndRotation(0.0F, 0.48F, -3.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition head_r3 = real_head.addOrReplaceChild("head_r3", CubeListBuilder.create().texOffs(0, 10).addBox(-1.5F, -1.75F, -2.25F, 3.0F, 2.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.48F, -3.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition head_r4 = real_head.addOrReplaceChild("head_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 3.0F, -1.25F, 6.0F, 4.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, -3.0F, 5.0F, -0.8727F, 0.0F, 0.0F));

		PartDefinition head_r5 = real_head.addOrReplaceChild("head_r5", CubeListBuilder.create().texOffs(53, 22).mirror().addBox(-0.2F, -1.25F, -1.9F, 1.0F, 2.0F, 4.0F, new CubeDeformation(-0.11F)).mirror(false), PartPose.offsetAndRotation(2.75F, -2.8F, 0.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition head_r6 = real_head.addOrReplaceChild("head_r6", CubeListBuilder.create().texOffs(53, 24).mirror().addBox(-0.15F, -1.35F, -2.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(2.75F, -1.3F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition head_r7 = real_head.addOrReplaceChild("head_r7", CubeListBuilder.create().texOffs(53, 24).addBox(-0.85F, -1.35F, -2.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-2.75F, -1.3F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition head_r8 = real_head.addOrReplaceChild("head_r8", CubeListBuilder.create().texOffs(53, 22).addBox(-0.8F, -1.25F, -1.9F, 1.0F, 2.0F, 4.0F, new CubeDeformation(-0.11F)), PartPose.offsetAndRotation(-2.75F, -2.8F, 0.0F, 0.0F, 0.0F, 0.3491F));
