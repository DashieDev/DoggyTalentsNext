...
public class BorzoiModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = real_head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(25, 36).addBox(-1.7F, 0.075F, -2.4F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.5F))
		.texOffs(0, 55).addBox(-1.7F, -0.775F, -2.9F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, -0.095F, -4.05F, 0.2618F, 0.0F, 0.0F));
