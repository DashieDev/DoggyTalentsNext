...
public class BorzoiModel extends DogModel{
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition realhead_r1 = real_head.addOrReplaceChild("realhead_r1", CubeListBuilder.create().texOffs(25, 36).addBox(-1.5F, -0.7015F, -5.8978F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.5F))
		.texOffs(0, 55).addBox(-1.5F, -1.5515F, -6.3978F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, -0.095F, -1.05F, -0.0873F, 0.0F, 0.0F));
