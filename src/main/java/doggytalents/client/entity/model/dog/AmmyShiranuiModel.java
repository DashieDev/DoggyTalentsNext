...
public class AmmyShiranuiModel extends DogModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(24, 23).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(33, 24).mirror().addBox(1.1F, -0.3F, -1.4F, 1.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.0187F, -3.9147F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 14.0F, -3.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition Swirly_r1 = upper_body.addOrReplaceChild("Swirly_r1", CubeListBuilder.create().texOffs(0, 32).addBox(3.1F, -11.5F, 0.75F, 1.0F, 11.0F, 13.0F, new CubeDeformation(0.0F))
		.texOffs(0, 32).mirror().addBox(-4.1F, -11.5F, 0.75F, 1.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 9.9813F, -2.9147F, 0.2618F, 0.0F, 0.0F));
		...
		.texOffs(23, 0).addBox(-1.5F, -0.07F, -4.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition left_ear = real_head.addOrReplaceChild("left_ear", CubeListBuilder.create(), PartPose.offset(-2.0F, -3.0F, 0.0F));
		...
		PartDefinition right_ear = real_head.addOrReplaceChild("right_ear", CubeListBuilder.create(), PartPose.offset(2.0F, -3.0F, 0.0F));
		...
		.texOffs(10, 9).mirror().addBox(-3.25F, -11.55F, -8.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offset(0.0F, 9.5F, 7.25F));
