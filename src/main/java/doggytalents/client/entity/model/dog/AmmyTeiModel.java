...
public class AmmyTeiModel extends DogModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hind_leg = partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(0, 28).addBox(-0.7F, -1.35F, -1.8F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(33, 43).mirror().addBox(-0.8F, 0.35F, -3.2F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.8F, 17.35F, 7.8F));
		...
		PartDefinition bone = upper_body.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition mane_rotation = bone.addOrReplaceChild("mane_rotation", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-4.1F, -5.5F, -4.5F, 1.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 16.0F, 2.5F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition body_rotation = bone2.addOrReplaceChild("body_rotation", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -2.0F, -0.25F, 1.5708F, 0.0F, 0.0F));
		...
		.texOffs(25, 13).addBox(-3.0F, -3.7F, -1.45F, 6.0F, 2.0F, 3.0F, new CubeDeformation(-0.45F))
		.texOffs(38, 0).mirror().addBox(-1.75F, 0.43F, -4.75F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)).mirror(false)
		.texOffs(38, 0).addBox(0.75F, 0.43F, -4.75F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F))
		...
		.texOffs(26, 14).addBox(-3.0F, -1.0F, -0.25F, 6.0F, 2.0F, 2.0F, new CubeDeformation(-0.35F)), PartPose.offsetAndRotation(0.0F, -2.7F, 1.75F, 0.0F, 3.1416F, 0.0F));
		...
		.texOffs(41, 11).mirror().addBox(0.1125F, -2.3F, -1.4375F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offset(1.6375F, -0.7F, -0.3125F));
		...
		.texOffs(41, 11).addBox(-2.1125F, -2.3F, -1.4375F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offset(-1.6375F, -0.7F, -0.3125F));
