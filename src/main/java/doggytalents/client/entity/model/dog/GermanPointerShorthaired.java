...
public class GermanPointerShorthaired extends DogModel{

    public GermanPointerShorthaired(ModelPart box) {
        super(box);
    }
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(9, 18).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(-0.35F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition head_r1 = real_head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -1.75F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(-0.35F)), PartPose.offsetAndRotation(0.5F, 1.0F, 2.0F, -0.6545F, 0.0F, 0.0F));
		...
		PartDefinition head_r2 = snout_upper.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 10).addBox(-1.5F, -1.0F, -2.25F, 3.0F, 2.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -9.52F, -9.5F, 0.0873F, 0.0F, 0.0F));

		PartDefinition snout_lower = snout.addOrReplaceChild("snout_lower", CubeListBuilder.create().texOffs(0, 12).addBox(-1.5F, -9.02F, -11.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 9.0F, 9.0F));

		PartDefinition right_ear = real_head.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(17, 13).addBox(-1.8F, -0.5F, -1.5F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F))
		.texOffs(17, 13).addBox(-2.3F, 0.25F, -1.25F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F))
		.texOffs(17, 13).addBox(-1.55F, -1.15F, -1.25F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F))
		...
		PartDefinition left_ear = real_head.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(17, 13).mirror().addBox(0.8F, -0.5F, -1.5F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false)
		.texOffs(17, 13).mirror().addBox(1.3F, 0.25F, -1.25F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false)
		.texOffs(17, 13).mirror().addBox(0.55F, -1.15F, -1.25F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false)
