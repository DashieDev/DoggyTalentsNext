...
public class DachshundModel extends DogModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 16.5F, -7.5F));

		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(24, 13).addBox(-3.0F, -3.25F, -1.25F, 6.0F, 6.0F, 4.0F, new CubeDeformation(-0.1F))
		.texOffs(26, 43).addBox(-1.5F, -0.27F, -4.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F))
		.texOffs(23, 0).addBox(-3.0F, -3.7F, -1.25F, 6.0F, 1.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		.texOffs(18, 49).addBox(-2.55F, -0.95F, -2.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.05F)), PartPose.offset(-2.0F, -1.25F, 1.25F));
		...
		.texOffs(18, 49).mirror().addBox(2.3F, 0.2F, -2.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.05F)).mirror(false), PartPose.offset(2.0F, -1.25F, 1.25F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 14.0F, 2.0F, 1.7017F, 0.0F, 0.0F));

		PartDefinition body_rotation_r1 = body.addOrReplaceChild("body_rotation_r1", CubeListBuilder.create().texOffs(0, 13).addBox(-3.0F, -3.7199F, -1.6637F, 6.0F, 11.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 1.0F, -3.5F, -0.0873F, 0.0F, 0.0F));
