...
public class PochitaModel extends DogModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.02F, 2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(1.5F))
		.texOffs(0, 10).addBox(-3.25F, 3.77F, -1.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.15F))
		.texOffs(0, 10).mirror().addBox(0.0F, 3.77F, -0.85F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.15F)).mirror(false), PartPose.offset(0.0F, -3.52F, -4.0F));

		PartDefinition chainsaw = real_head.addOrReplaceChild("chainsaw", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition right_front_leg = partdefinition.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, -1.5F, -2.0F, 2.0F, 8.5F, 2.0F, new CubeDeformation(0.35F)), PartPose.offset(-2.5F, 17.0F, -4.0F));
