...
public class KoModel extends DogModel<Dog> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		CubeListBuilder.create().texOffs(24, 13).addBox(-2.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.1F))
			.texOffs(11, 23).addBox(-2.0F, -3.65F, -2.0F, 6.0F, 1.0F, 4.0F, new CubeDeformation(-0.25F))
			.texOffs(3, 5).addBox(-2.0F, 1.4F, -2.0F, 6.0F, 3.0F, 4.0F, new CubeDeformation(-0.6F))
			.texOffs(3, 5).addBox(-2.0F, 1.6F, -3.2F, 6.0F, 3.0F, 4.0F, new CubeDeformation(-0.9F))
			.texOffs(3, 5).addBox(-2.0F, 1.6F, -3.2F, 6.0F, 3.0F, 4.0F, new CubeDeformation(-0.9F))
			.texOffs(23, 0).addBox(-0.5F, -0.42F, -4.2F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.3F)),
        PartPose.ZERO);
		...
		.texOffs(20, 8).addBox(1.5F, -12.8F, -8.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offset(1.0F, 10.5F, 7.0F));
