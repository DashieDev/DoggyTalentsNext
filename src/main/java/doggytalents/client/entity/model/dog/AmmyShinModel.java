...
public class AmmyShinModel extends DogModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_head = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(24, 13).addBox(-3.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(25, 14).addBox(-3.0F, -3.35F, -2.4F, 6.0F, 2.0F, 3.0F, new CubeDeformation(-0.45F))
		.texOffs(26, 14).addBox(-3.0F, -4.05F, -2.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(-0.45F))
		.texOffs(23, 1).addBox(-1.75F, 0.08F, -4.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(-0.1F))
		.texOffs(26, 1).addBox(0.75F, 0.08F, -4.25F, 1.0F, 3.0F, 3.0F, new CubeDeformation(-0.1F))
		.texOffs(23, 0).addBox(-1.5F, -0.22F, -5.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		.texOffs(26, 14).addBox(-3.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(-0.45F)), PartPose.offsetAndRotation(0.0F, -3.05F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		.texOffs(0, 0).addBox(-0.8F, -1.3667F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offset(1.6F, -3.1833F, -0.4F));

		PartDefinition right_ear = real_head.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0F, -1.9667F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		.texOffs(0, 0).mirror().addBox(-0.8F, -2.6667F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
		.texOffs(0, 0).mirror().addBox(-1.2F, -1.3667F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.15F)).mirror(false), PartPose.offset(-1.6F, -3.1833F, -0.4F));
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(0.0F, 12.5F, 7.75F));

		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(0, 28).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.3F))
		.texOffs(0, 28).addBox(-1.0F, 3.5F, 0.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F))
		.texOffs(33, 24).mirror().addBox(-0.7F, -0.8F, -2.3F, 1.0F, 8.0F, 7.0F, new CubeDeformation(-1.5F)).mirror(false)
		.texOffs(33, 24).addBox(-0.3F, -0.8F, -2.3F, 1.0F, 8.0F, 7.0F, new CubeDeformation(-1.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tail_r1 = real_tail.addOrReplaceChild("tail_r1", CubeListBuilder.create().texOffs(0, 28).addBox(-1.0F, -1.25F, -1.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, 3.75F, 1.25F, 0.1309F, 0.0F, 0.0F));
