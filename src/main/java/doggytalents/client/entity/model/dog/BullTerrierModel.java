...
public class BullTerrierModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r5 = left_ear.addOrReplaceChild("head_r5", CubeListBuilder.create().texOffs(45, 1).addBox(-0.5177F, -1.8641F, -1.9077F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.05F)), PartPose.offsetAndRotation(-0.9845F, -2.738F, 0.7F, 0.0598F, -0.8811F, 0.1414F));
		...
		PartDefinition head_r9 = right_ear.addOrReplaceChild("head_r9", CubeListBuilder.create().texOffs(45, 1).mirror().addBox(-1.4823F, -1.8641F, -1.9077F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offsetAndRotation(0.8341F, -2.7611F, 0.7F, 0.0598F, 0.8811F, -0.1414F));
