...
public class CollieBorderModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(31, 39).addBox(-1.0F, 8.15F, 1.8F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.25F))
		.texOffs(32, 39).addBox(-1.0F, 7.05F, 1.3F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.05F))
		.texOffs(10, 22).addBox(-1.0F, 2.95F, -0.1F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.15F))
		.texOffs(32, 39).addBox(-1.0F, 5.85F, 0.7F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.1F))
