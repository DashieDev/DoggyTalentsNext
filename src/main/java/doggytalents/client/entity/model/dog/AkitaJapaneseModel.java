...
public class AkitaJapaneseModel extends DogModel{

    public AkitaJapaneseModel(ModelPart box) {
        super(box);
    }
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition real_tail = tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(9, 18).addBox(-1.0F, 0.25F, -2.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition right_hind_leg = partdefinition.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offset(-1.5F, 16.0F, 7.0F));

		PartDefinition left_hind_leg = partdefinition.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offset(1.5F, 16.0F, 7.0F));
		...
		PartDefinition upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(21, 0).addBox(-4.0F, -2.75F, -3.9F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.15F)), PartPose.offsetAndRotation(0.0F, 14.25F, -3.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition mane_rotation_r1 = upper_body.addOrReplaceChild("mane_rotation_r1", CubeListBuilder.create().texOffs(22, 1).addBox(-3.0F, -4.5F, -2.55F, 8.0F, 5.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.25F, -0.6981F, 0.0F, 0.0F));
		...
		PartDefinition headfur = real_head.addOrReplaceChild("headfur", CubeListBuilder.create().texOffs(52, 18).addBox(1.25F, -11.3F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(51, 27).addBox(2.0F, -12.3F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(52, 28).addBox(3.5F, -12.8F, -8.6F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(54, 27).addBox(2.25F, -14.05F, -8.6F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(54, 25).addBox(2.25F, -15.05F, -8.65F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(51, 27).addBox(1.0F, -14.8F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(52, 18).mirror().addBox(-4.5F, -11.3F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false)
		.texOffs(52, 18).mirror().addBox(-4.25F, -12.05F, -9.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false)
		.texOffs(52, 18).mirror().addBox(-3.5F, -13.05F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false)
		.texOffs(52, 18).addBox(0.5F, -13.05F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(52, 18).addBox(1.25F, -12.05F, -9.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(51, 27).mirror().addBox(-5.25F, -12.3F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(52, 18).mirror().addBox(-2.75F, -10.05F, -8.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false)
		.texOffs(51, 17).mirror().addBox(-4.0F, -10.55F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(52, 18).addBox(0.75F, -10.05F, -8.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(52, 18).addBox(-1.0F, -9.55F, -8.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.3F))
		.texOffs(51, 17).addBox(0.75F, -10.55F, -8.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(52, 28).mirror().addBox(-4.75F, -12.8F, -8.35F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.3F)).mirror(false)
		.texOffs(54, 27).mirror().addBox(-4.5F, -14.05F, -8.6F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(54, 25).mirror().addBox(-3.5F, -15.05F, -8.65F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(51, 27).mirror().addBox(-4.25F, -14.8F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(54, 27).mirror().addBox(-3.0F, -15.8F, -8.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(54, 25).mirror().addBox(-2.0F, -16.3F, -8.65F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false)
		.texOffs(51, 27).mirror().addBox(-2.75F, -16.3F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(51, 27).addBox(-0.25F, -16.3F, -8.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(54, 25).addBox(1.0F, -16.3F, -8.65F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(54, 27).addBox(1.0F, -15.8F, -8.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(52, 27).addBox(-3.85F, -14.75F, -5.95F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.1F))
		.texOffs(52, 27).addBox(-4.25F, -13.75F, -5.8F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.1F))
		.texOffs(52, 27).mirror().addBox(1.25F, -13.75F, -5.8F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)).mirror(false)
		.texOffs(43, 27).addBox(0.85F, -14.75F, -6.05F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.2F))
		.texOffs(43, 27).addBox(0.1F, -15.35F, -6.05F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.05F))
		.texOffs(43, 27).mirror().addBox(-3.1F, -15.35F, -6.05F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.05F)).mirror(false)
		.texOffs(47, 24).addBox(-1.0F, -15.55F, -7.45F, 2.0F, 4.0F, 4.0F, new CubeDeformation(-0.05F))
		.texOffs(52, 27).addBox(-3.0F, -11.75F, -6.05F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.15F))
		.texOffs(52, 27).addBox(-2.25F, -12.75F, -5.8F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.15F))
		.texOffs(47, 24).addBox(-0.75F, -12.75F, -7.05F, 2.0F, 4.0F, 4.0F, new CubeDeformation(-0.4F))
		.texOffs(47, 24).addBox(0.25F, -13.8F, -7.2F, 2.0F, 4.0F, 4.0F, new CubeDeformation(-0.4F)), PartPose.offset(0.0F, 12.5F, 7.3F));
