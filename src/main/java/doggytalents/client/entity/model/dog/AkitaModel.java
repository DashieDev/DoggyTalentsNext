...
public class AkitaModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mane_rotation_r1 = upper_body.addOrReplaceChild("mane_rotation_r1", CubeListBuilder.create().texOffs(22, 1).addBox(-3.0F, -4.5F, -2.55F, 8.0F, 5.0F, 6.0F, new CubeDeformation(-0.35F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.25F, -0.6981F, 0.0F, 0.0F));
