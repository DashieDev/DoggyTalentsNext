...
public class TakeModel extends DogModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		CubeListBuilder var4 = CubeListBuilder.create().texOffs(39, 1).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, CubeDeformation.NONE);
		...
		.texOffs(42, 25).addBox(-1.0F, 7.0F, 0.75F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.3F))
		.texOffs(33, 25).addBox(-1.0F, 3.0F, 0.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.05F)), PartPose.ZERO);
