...
public class BorzoiLongModel extends DogModel{
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = real_head.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 1.155F, -1.05F));

		PartDefinition head_r2 = bone.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 55).addBox(-1.5F, -5.5515F, -221.3978F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.4F))
		...
		.texOffs(0, 46).addBox(-1.5F, -5.5515F, -112.7978F, 3.0F, 2.0F, 7.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, 4.25F, 0.7F, -0.0175F, 0.0F, 0.0F));
