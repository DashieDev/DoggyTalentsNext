...
public class JunoModel extends DogModel<Dog> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		.texOffs(13, 7).addBox(-4.5F, -15.25F, -8.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(13, 7).addBox(-3.6F, -15.15F, -8.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F))
		.texOffs(13, 7).addBox(-4.0F, -15.2F, -9.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F))
		.texOffs(13, 6).addBox(-4.5F, -15.0F, -7.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(13, 6).addBox(-5.0F, -14.75F, -7.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(13, 6).addBox(-5.0F, -14.95F, -8.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F))
		.texOffs(13, 7).addBox(-4.75F, -15.15F, -9.15F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F))
		.texOffs(18, 15).mirror().addBox(2.4F, -14.75F, -8.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.1F)).mirror(false)
		.texOffs(11, 5).mirror().addBox(2.25F, -13.75F, -8.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.05F)).mirror(false)
		.texOffs(14, 6).mirror().addBox(3.5F, -15.25F, -8.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(14, 6).mirror().addBox(2.6F, -15.15F, -8.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false)
		.texOffs(14, 6).mirror().addBox(3.0F, -15.2F, -9.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false)
		...
		.texOffs(10, 7).addBox(1.25F, -9.3F, -8.75F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(10, 7).addBox(3.75F, -8.8F, -9.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F))
		.texOffs(10, 7).addBox(2.75F, -7.8F, -8.75F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F))
		.texOffs(10, 7).addBox(5.0F, -9.55F, -9.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F))
		.texOffs(10, 7).addBox(4.0F, -10.8F, -8.6F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.1F))
		.texOffs(10, 6).addBox(-2.5F, -14.0F, -8.5F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(9, 6).addBox(2.5F, -10.3F, -8.75F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(10, 7).mirror().addBox(-4.25F, -9.3F, -8.75F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(10, 7).mirror().addBox(-4.75F, -8.8F, -9.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false)
		.texOffs(10, 7).mirror().addBox(-3.75F, -7.8F, -8.75F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false)
		.texOffs(10, 7).mirror().addBox(-6.0F, -9.55F, -9.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false)
