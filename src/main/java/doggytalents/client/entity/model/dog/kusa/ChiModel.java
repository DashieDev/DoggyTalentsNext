...
public class ChiModel extends DogModel<Dog> {
	...
	public static LayerDefinition createBodyLayer() {
        ...
        var real_head = head.addOrReplaceChild("real_head", 
			...
			.texOffs(24, 13).addBox(-2.0F, -3.75F, -2.0F, 6.0F, 1.0F, 4.0F, new CubeDeformation(-0.3F))
		...
		.texOffs(0, 0).mirror().addBox(-1.55F, 0.1F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.5236F, 0.0F));
		ear.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 13).addBox(0.15F, -1.2F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F))
		...
		.texOffs(10, 9).mirror().addBox(-4.5F, -12.8F, -8.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offset(1.0F, 10.5F, 7.0F));
