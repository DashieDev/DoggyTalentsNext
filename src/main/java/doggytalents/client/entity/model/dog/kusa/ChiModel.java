...
public class ChiModel extends DogModel {
	...
	public static LayerDefinition createBodyLayer() {
        ...
        var upper_body = partdefinition.addOrReplaceChild("upper_body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(0F, 14.0F, -3.0F, 1.5707964F, 0.0F, 0.0F));

		CubeListBuilder var4 = CubeListBuilder.create().texOffs(24, 23).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, CubeDeformation.NONE);
		...
		tail.addOrReplaceChild("real_tail", CubeListBuilder.create().texOffs(24, 23).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.2F))
		.texOffs(24, 24).addBox(-1.0F, 5.0F, 1.8F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F))
		.texOffs(24, 24).addBox(-1.0F, 1.8F, 3.1F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.2F))
		.texOffs(24, 24).addBox(-1.0F, 1.4F, 2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F))
		.texOffs(24, 24).addBox(-1.0F, 4.0F, 0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.15F))
		.texOffs(24, 24).addBox(-1.0F, 4.0F, 3.6F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.15F)), PartPose.ZERO);
