...
public class KitsuneMaskModel extends SyncedAccessoryModel {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = rotator.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(49, 17).addBox(-2.5F, -1.4594F, -0.0437F, 5.0F, 6.0F, 1.0F, new CubeDeformation(0.4F))
		.texOffs(54, 29).addBox(-1.5F, 3.5206F, -2.0437F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.05F)), PartPose.offsetAndRotation(0.0F, -1.8509F, -4.0637F, -0.2618F, 0.0F, 0.0F));
