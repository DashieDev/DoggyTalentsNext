...
public class DogBackpackModel extends SyncedAccessoryModel {
    ...
    public static LayerDefinition createChestLayer() {
        ...
        var2.addOrReplaceChild("right_chest", CubeListBuilder.create().texOffs(52, 0).addBox(2.0F - 0.01F, -1F, 0F, 2, 7, 4), PartPose.ZERO);
        var2.addOrReplaceChild("left_chest", CubeListBuilder.create().texOffs(52, 0).addBox(-4.0F - 0.01F, -1F, 0F, 2F, 7F, 4F), PartPose.ZERO);
