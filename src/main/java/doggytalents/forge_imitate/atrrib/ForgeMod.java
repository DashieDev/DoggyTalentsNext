...
public class ForgeMod {
    ...
    public static RegistryObject<Attribute> ENTITY_GRAVITY = ATTRIBUTES.register("forge_entity_gravity", () -> new RangedAttribute("forge_imitate.forge_entity_gravity", 0.08D, -8.0D, 8.0D).setSyncable(true));
