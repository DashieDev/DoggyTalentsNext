...
public class GuardModeGoal extends NearestAttackableTargetGoal<Mob> {
    ...
    protected void findTarget() {
       this.target = ((ServerLevel)this.dog.level()).getNearestEntity(this.targetType, this.targetConditions, this.dog, this.owner.getX(), this.owner.getEyeY(), this.owner.getZ(), this.getTargetSearchArea(GUARD_DISTANCE));
    }
