...
public class Dim2BlockPosSerializer implements EntityDataSerializer<Dimension2BlockPosMap> {
    ...
    public void write(FriendlyByteBuf buf, Dimension2BlockPosMap value) {
        ...
        for (var entry : value.entrySet()) {
            ...
            EntityDataSerializers.BLOCK_POS.write(buf, entry.getValue());
        }
    }
    ...
    public Dimension2BlockPosMap read(FriendlyByteBuf buf) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            var pos = EntityDataSerializers.BLOCK_POS.read(buf);
