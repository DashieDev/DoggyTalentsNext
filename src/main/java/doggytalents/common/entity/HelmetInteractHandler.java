...
public class HelmetInteractHandler implements IDogItem {
    ...
    private static final Map<Item, RegistryObject<? extends Accessory>> MAPPING = new ImmutableMap.Builder<Item, RegistryObject<? extends Accessory>>()
        ...
        .put(Items.IRON_BOOTS,     DoggyAccessories.IRON_BODY_PIECE)
        .put(Items.DIAMOND_BOOTS,     DoggyAccessories.DIAMOND_BODY_PIECE)
        .put(Items.GOLDEN_BOOTS,     DoggyAccessories.GOLDEN_BODY_PIECE)
        .put(Items.CHAINMAIL_BOOTS,     DoggyAccessories.CHAINMAIL_BODY_PIECE)
        .put(Items.NETHERITE_BOOTS,     DoggyAccessories.NETHERITE_BODY_PIECE)
