...
public class PackHandler {
    ...
    private static Optional<Pack> findAndCreatePack(PackType type, String id, Component display_name,
        ...
        var jarContents = mod_info.getOwningFile().getFile().getContents();

        var known_pack_info = new KnownPack(Constants.MOD_ID, id, version);
        ...
        var pack = Pack.readMetaAndCreate(
            pack_location_info,
            new JarContentsPackResources.JarContentsResourcesSupplier(jarContents, mod_path),
            type,
