...
public class DTItemTagsProvider extends ItemTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        createTag(DoggyTags.DOG_BOOSTING_FOOD, () -> Items.GOLDEN_APPLE, () -> Items.ENCHANTED_GOLDEN_APPLE, () -> Items.GOLDEN_CARROT, 
            DoggyItems.EGG_SANDWICH, 
            DoggyItems.GOLDEN_A_FIVE_WAGYU,
            DoggyItems.ONIGIRI, 
            DoggyItems.SALMON_SUSHI, 
            DoggyItems.EDAMAME_UNPODDED, 
            DoggyItems.TOFU, 
            DoggyItems.ABURAAGE, 
            DoggyItems.SAUSAGE
