...
public class Resources {
    ...
    public static final ResourceLocation WANG_WANG = getEntity("dog", "custom/wangwang");
    ...
    public static final ResourceLocation FISHER_HAT = getEntity("dog", "fisher_hat");
    ...
    public static final ResourceLocation BUNNY_EARS = getEntity("dog", "bunny_ears");
    ...
    public static final ResourceLocation ANGEL_WINGS = getEntity("dog", "angel_wings");
    public static final ResourceLocation ANGEL_HALO = getEntity("dog", "angel_halo");
    public static final ResourceLocation YETI_GOOSE = getEntity("dog", "goose");
    ...
    public static final ResourceLocation PIANO_UPRIGHT_WHITE = Util.getResource("textures/misc/piano/upright_white.png");
