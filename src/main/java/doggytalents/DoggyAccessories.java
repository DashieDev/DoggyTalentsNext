...
public class DoggyAccessories {
    ...
    public static final Supplier<DoubleDyeableAccessory> DYED_ORB = register("locator_orb_dyeable", () -> new DyeableLocatorOrb(DoggyItems.DYED_ORB).setModelTexture(Resources.DYEABLE_ORB_BG).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final Supplier<DoubleDyeableAccessory> STRIPED_SCARF = register("striped_scarf", () -> new StripedScarf(DoggyItems.STRIPED_SCARF).setModelTexture(Resources.STRIPED_SCARF_BG).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
