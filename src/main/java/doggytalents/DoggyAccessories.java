...
public class DoggyAccessories {
    ...
    public static final RegistryObject<LocatorOrbAccessory> CHI_ORB = register("locator_orb_chi", () -> new LocatorOrbAccessory(DoggyItems.CHI_ORB).setModelTexture(Resources.CHI_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> CHU_ORB = register("locator_orb_chu", () -> new LocatorOrbAccessory(DoggyItems.CHU_ORB).setModelTexture(Resources.CHU_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> KO_ORB = register("locator_orb_ko", () -> new LocatorOrbAccessory(DoggyItems.KO_ORB).setModelTexture(Resources.KO_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> GI_ORB = register("locator_orb_gi", () -> new LocatorOrbAccessory(DoggyItems.GI_ORB).setModelTexture(Resources.GI_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> TEI_ORB = register("locator_orb_tei", () -> new LocatorOrbAccessory(DoggyItems.TEI_ORB).setModelTexture(Resources.TEI_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> REI_ORB = register("locator_orb_rei", () -> new LocatorOrbAccessory(DoggyItems.REI_ORB).setModelTexture(Resources.REI_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> SHIN_ORB = register("locator_orb_shin", () -> new LocatorOrbAccessory(DoggyItems.SHIN_ORB).setModelTexture(Resources.SHIN_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> JIN_ORB = register("locator_orb_jin", () -> new LocatorOrbAccessory(DoggyItems.JIN_ORB).setModelTexture(Resources.JIN_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
