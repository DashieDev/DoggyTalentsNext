...
public class DoggyAccessories {
    ...
    public static final RegistryObject<Clothing> DEATH_HOOD = register("death_hood", () -> new Clothing(DoggyItems.DEATH_HOOD).setModelTexture(Resources.DEATH_HOOD).setModelTextureX64(Resources.DEATH_HOOD_X64).setRenderTranslucent(true).setRenderer("DefaultAccessoryRenderer"));
