...
public class DoggyAccessories {
    ...
    public static final RegistryObject<Accessory> DIVINE_RETRIBUTION = register("divine_retribution", () -> new DivineRetribution(DoggyItems.DIVINE_RETRIBUTON).setModelTexture(Resources.DIVINE_RETRIBUTION).setRenderTranslucent(true));
    ...
    public static final RegistryObject<CeramonyGarb> CERA_GARB = register("ceramonial_garb", () -> new CeramonyGarb(DoggyItems.CERA_GARB).setAccessoryRenderType(AccessoryRenderType.MODEL));
