...
public class DoggyAccessories {
    ...
    public static final RegistryObject<LocatorOrbAccessory> KA_ORB = register("locator_orb_ka", () -> new LocatorOrbAccessory(DoggyItems.KA_ORB, 0xfff70f00).setModelTexture(Resources.KA_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> SUI_ORB = register("locator_orb_sui", () -> new LocatorOrbAccessory(DoggyItems.SUI_ORB, 0xff1d78f5).setModelTexture(Resources.SUI_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
    public static final RegistryObject<LocatorOrbAccessory> MOKU_ORB = register("locator_orb_moku", () -> new LocatorOrbAccessory(DoggyItems.MOKU_ORB, 0xff3f862c).setModelTexture(Resources.MOKU_ORB).setAccessoryRenderType(AccessoryRenderType.MODEL).setRenderTranslucent(true));
